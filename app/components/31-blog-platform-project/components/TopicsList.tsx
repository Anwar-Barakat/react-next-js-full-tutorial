  ...
  return (
    <div className="glass rounded-2xl shadow-lg p-5 text-foreground">
      ...
      <ul className="space-y-3">
        <li className="p-3 rounded-xl hover:bg-muted transition-all duration-300 hover:shadow-sm cursor-pointer group border border-transparent hover:border-primary/20">
