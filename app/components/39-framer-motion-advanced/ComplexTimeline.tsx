...
const ComplexTimeline = () => {
  return (
    <div className="card flex flex-col items-center">
      <h3 className="text-xl font-bold text-white mb-4">Challenge 3: Complex Timeline Animation</h3>
      <motion.div
        className="w-full max-w-sm p-4 bg-gray-700 rounded-lg flex flex-col items-center space-y-4"
