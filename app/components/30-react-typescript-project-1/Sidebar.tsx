...
const Sidebar: React.FC = () => {
  ...
  const renderNavItem = (item: NavItem, isActive: boolean) => (
    <li key={item.id}>
      <button
        ...
        className={`flex items-center justify-center p-2 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-[#1a1c1e] ${
          isActive
  ...
  return (
    <aside 
      className="sidebar fixed top-0 left-0 w-20 h-screen bg-[#1a1c1e] text-white flex flex-col justify-between items-center py-4 z-30"
      role="navigation"
