# Assignment: Conditional Rendering in React
...
Create a new file called `Weather.tsx`.
...
Create a new file called `UserStatus.tsx`.
...
Create a new file called `GreetingConditional.tsx`.
Inside this file, create a functional component called `GreetingConditional`.
The component should:
...
In your `app/page.tsx` file, import the `Weather`, `UserStatus`, and `Greeting` components.
Inside the `Home` component's return statement, render all three components, passing appropriate props to each.
