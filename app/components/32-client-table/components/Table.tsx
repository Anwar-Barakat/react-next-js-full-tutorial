...
const Table = () => {
  ...
  return (
    <div className="p-8">
      <h2 className="text-3xl font-bold text-foreground mb-6">Clients</h2>
      <div className="flex items-center mb-6 space-x-4">
        <input
          type="text"
          placeholder="Filter by client name..."
          className="input bg-muted text-foreground focus:outline-none focus:ring-2 focus:ring-primary"
      ...
      <div className="glass overflow-x-auto overflow-y-auto max-h-[500px] rounded-lg shadow-lg">
            ...
            {filteredData.length > 0 ? (
              filteredData.map((item, index) => (
                <tr key={index} className="border-b border-border hover:bg-muted">
                  ...
                  <td className="p-4 text-muted-foreground w-[150px]">{item.date}</td>
                </tr>
              ))
            ) : (
              <tr>
